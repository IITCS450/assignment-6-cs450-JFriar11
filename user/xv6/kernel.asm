...
8010041f:	e8 7c 5a 00 00       	call   80105ea0 <uartputc>
...
801004ea:	e8 b1 59 00 00       	call   80105ea0 <uartputc>
801004ef:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f6:	e8 a5 59 00 00       	call   80105ea0 <uartputc>
801004fb:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100502:	e8 99 59 00 00       	call   80105ea0 <uartputc>
...
80100b14:	0f 85 f1 00 00 00    	jne    80100c0b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b1a:	e8 f1 64 00 00       	call   80107010 <setupkvm>
...
80100b8b:	e8 b0 62 00 00       	call   80106e40 <allocuvm>
...
80100bc1:	e8 aa 61 00 00       	call   80106d70 <loaduvm>
...
80100c03:	e8 88 63 00 00       	call   80106f90 <freevm>
  if(ip){
...
80100c81:	31 f6                	xor    %esi,%esi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 28 64 00 00       	call   801070b0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cee:	e8 8d 65 00 00       	call   80107280 <copyout>
...
80100d03:	e8 88 62 00 00       	call   80106f90 <freevm>
...
80100d5f:	e8 1c 65 00 00       	call   80107280 <copyout>
...
80100dcb:	e8 10 5e 00 00       	call   80106be0 <switchuvm>
  freevm(oldpgdir);
80100dd0:	89 34 24             	mov    %esi,(%esp)
80100dd3:	e8 b8 61 00 00       	call   80106f90 <freevm>
  return 0;
...
8010271b:	0f b6 91 80 7b 10 80 	movzbl -0x7fef8480(%ecx),%edx
  shift ^= togglecode[data];
80102722:	0f b6 81 80 7a 10 80 	movzbl -0x7fef8580(%ecx),%eax
  shift |= shiftcode[data];
...
80102738:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010273b:	8b 04 85 60 7a 10 80 	mov    -0x7fef85a0(,%eax,4),%eax
...
80102775:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102778:	0f b6 81 80 7b 10 80 	movzbl -0x7fef8480(%ecx),%eax
...
80102ff2:	e8 49 2a 00 00       	call   80105a40 <idtinit>
...
80103074:	e8 37 2d 00 00       	call   80105db0 <uartinit>
  pinit();         // process table
80103079:	e8 42 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
8010307e:	e8 3d 29 00 00       	call   801059c0 <tvinit>
  binit();         // buffer cache
...
80103814:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103817:	c7 40 14 b2 59 10 80 	movl   $0x801059b2,0x14(%eax)
  p->context = (struct context*)sp;
...
801038c6:	68 b6 75 10 80       	push   $0x801075b6
...
80103a2f:	68 e6 75 10 80       	push   $0x801075e6
80103a34:	50                   	push   %eax
80103a35:	e8 16 0e 00 00       	call   80104850 <safestrcpy>
  p->cwd = namei("/");
80103a3a:	c7 04 24 ef 75 10 80 	movl   $0x801075ef,(%esp)
...
80103a73:	68 cd 75 10 80       	push   $0x801075cd
...
80103aca:	e8 71 33 00 00       	call   80106e40 <allocuvm>
...
80103b38:	e8 c3 35 00 00       	call   80107100 <copyuvm>
...
80103c60:	e8 7b 2f 00 00       	call   80106be0 <switchuvm>
...
80103c72:	e8 34 0c 00 00       	call   801048ab <swtch>
      switchkvm();
80103c77:	e8 54 2f 00 00       	call   80106bd0 <switchkvm>
      c->proc = 0;
...
80103e7d:	68 3e 76 10 80       	push   $0x8010763e
80103e82:	e8 f9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103e87:	83 ec 0c             	sub    $0xc,%esp
80103e8a:	68 31 76 10 80       	push   $0x80107631
...
80103f69:	e8 22 30 00 00       	call   80106f90 <freevm>
        p->pid = 0;
...
80103fc0:	68 4a 76 10 80       	push   $0x8010764a
...
801040c9:	68 50 76 10 80       	push   $0x80107650
801040ce:	e8 ad c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040d3:	83 ec 0c             	sub    $0xc,%esp
801040d6:	68 4a 76 10 80       	push   $0x8010764a
...
801041db:	68 0f 78 10 80       	push   $0x8010780f
...
801041fc:	74 ea                	je     801041e8 <procdump+0x28>
      state = "???";
801041fe:	ba 61 76 10 80       	mov    $0x80107661,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104203:	83 f8 05             	cmp    $0x5,%eax
80104206:	77 11                	ja     80104219 <procdump+0x59>
80104208:	8b 14 85 80 7c 10 80 	mov    -0x7fef8380(,%eax,4),%edx
      state = "???";
8010420f:	b8 61 76 10 80       	mov    $0x80107661,%eax
...
8010421e:	68 65 76 10 80       	push   $0x80107665
...
8010428a:	68 98 76 10 80       	push   $0x80107698
...
801044e5:	68 a3 76 10 80       	push   $0x801076a3
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 ba 76 10 80       	push   $0x801076ba
...
8010455b:	68 c1 76 10 80       	push   $0x801076c1
...
80104688:	68 c9 76 10 80       	push   $0x801076c9
...
80104aac:	8b 14 85 a0 7c 10 80 	mov    -0x7fef8360(,%eax,4),%edx
...
80104ad8:	68 d1 76 10 80       	push   $0x801076d1
...
80104c24:	68 09 77 10 80       	push   $0x80107709
...
80104c3c:	68 08 77 10 80       	push   $0x80107708
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 09 77 10 80       	push   $0x80107709
...
80105078:	68 08 77 10 80       	push   $0x80107708
...
801051e5:	8d 45 f0             	lea    -0x10(%ebp),%eax
{
801051e8:	83 ec 18             	sub    $0x18,%esp
  if(argstr(0, &target) < 0 || argstr(1, &linkpath) < 0)
801051eb:	50                   	push   %eax
801051ec:	6a 00                	push   $0x0
801051ee:	e8 1d f8 ff ff       	call   80104a10 <argstr>
801051f3:	83 c4 10             	add    $0x10,%esp
801051f6:	85 c0                	test   %eax,%eax
801051f8:	0f 88 83 00 00 00    	js     80105281 <sys_symlink+0xa1>
801051fe:	83 ec 08             	sub    $0x8,%esp
80105201:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105204:	50                   	push   %eax
80105205:	6a 01                	push   $0x1
80105207:	e8 04 f8 ff ff       	call   80104a10 <argstr>
8010520c:	83 c4 10             	add    $0x10,%esp
8010520f:	85 c0                	test   %eax,%eax
80105211:	78 6e                	js     80105281 <sys_symlink+0xa1>
    return -1;

  begin_op();
80105213:	e8 28 db ff ff       	call   80102d40 <begin_op>

  ip = create(linkpath, T_SYMLINK, 0, 0);
80105218:	83 ec 0c             	sub    $0xc,%esp
8010521b:	31 c9                	xor    %ecx,%ecx
8010521d:	ba 04 00 00 00       	mov    $0x4,%edx
80105222:	6a 00                	push   $0x0
80105224:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105227:	e8 d4 f8 ff ff       	call   80104b00 <create>
  if(ip == 0){
...
80105233:	74 53                	je     80105288 <sys_symlink+0xa8>
    end_op();
    return -1;
  }

  len = strlen(target) + 1;        // ← assignment here, no type
80105235:	83 ec 0c             	sub    $0xc,%esp
80105238:	ff 75 f0             	push   -0x10(%ebp)
8010523b:	e8 50 f6 ff ff       	call   80104890 <strlen>
80105240:	8d 70 01             	lea    0x1(%eax),%esi
  if(writei(ip, target, 0, len) != len){
80105243:	56                   	push   %esi
80105244:	6a 00                	push   $0x0
80105246:	ff 75 f0             	push   -0x10(%ebp)
80105249:	53                   	push   %ebx
8010524a:	e8 61 c9 ff ff       	call   80101bb0 <writei>
8010524f:	83 c4 20             	add    $0x20,%esp
80105252:	39 f0                	cmp    %esi,%eax
80105254:	75 1a                	jne    80105270 <sys_symlink+0x90>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
8010525a:	e8 d1 c7 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010525f:	e8 4c db ff ff       	call   80102db0 <end_op>
  return 0;
80105264:	83 c4 10             	add    $0x10,%esp
80105267:	31 c0                	xor    %eax,%eax
}
80105269:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010526c:	5b                   	pop    %ebx
8010526d:	5e                   	pop    %esi
8010526e:	5d                   	pop    %ebp
8010526f:	c3                   	ret
...
80105274:	e8 b7 c7 ff ff       	call   80101a30 <iunlockput>
    end_op();
80105279:	e8 32 db ff ff       	call   80102db0 <end_op>
    return -1;
8010527e:	83 c4 10             	add    $0x10,%esp
    return -1;
80105281:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105286:	eb e1                	jmp    80105269 <sys_symlink+0x89>
    end_op();
80105288:	e8 23 db ff ff       	call   80102db0 <end_op>
    return -1;
8010528d:	eb f2                	jmp    80105281 <sys_symlink+0xa1>
8010528f:	90                   	nop
...
801052a5:	e8 66 f7 ff ff       	call   80104a10 <argstr>
801052aa:	83 c4 10             	add    $0x10,%esp
801052ad:	85 c0                	test   %eax,%eax
801052af:	0f 88 38 01 00 00    	js     801053ed <sys_open+0x15d>
801052b5:	83 ec 08             	sub    $0x8,%esp
801052b8:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
801052be:	50                   	push   %eax
801052bf:	6a 01                	push   $0x1
801052c1:	e8 8a f6 ff ff       	call   80104950 <argint>
801052c6:	83 c4 10             	add    $0x10,%esp
801052c9:	85 c0                	test   %eax,%eax
801052cb:	0f 88 1c 01 00 00    	js     801053ed <sys_open+0x15d>
    return -1;

  begin_op();
801052d1:	e8 6a da ff ff       	call   80102d40 <begin_op>

  if(omode & O_CREATE){
801052d6:	f6 85 65 ff ff ff 02 	testb  $0x2,-0x9b(%ebp)
801052dd:	0f 85 a5 00 00 00    	jne    80105388 <sys_open+0xf8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801052e6:	ff b5 60 ff ff ff    	push   -0xa0(%ebp)
801052ec:	e8 8f cd ff ff       	call   80102080 <namei>
801052f1:	83 c4 10             	add    $0x10,%esp
801052f4:	89 c3                	mov    %eax,%ebx
801052f6:	85 c0                	test   %eax,%eax
801052f8:	0f 84 72 01 00 00    	je     80105470 <sys_open+0x1e0>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105301:	be 0a 00 00 00       	mov    $0xa,%esi
80105306:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
    ilock(ip);
8010530c:	50                   	push   %eax
8010530d:	e8 8e c4 ff ff       	call   801017a0 <ilock>
    while(ip->type == T_SYMLINK){
80105312:	0f b7 43 50          	movzwl 0x50(%ebx),%eax
80105316:	83 c4 10             	add    $0x10,%esp
80105319:	66 83 f8 04          	cmp    $0x4,%ax
8010531d:	0f 85 2d 01 00 00    	jne    80105450 <sys_open+0x1c0>
80105323:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      if(++depth > MAXSYMLINK){          // cycle / chain too long
        iunlockput(ip);
        end_op();
        return -1;
      }
      n = readi(ip, target, 0, MAXPATH - 1);
80105328:	6a 7f                	push   $0x7f
8010532a:	6a 00                	push   $0x0
8010532c:	57                   	push   %edi
8010532d:	53                   	push   %ebx
8010532e:	e8 7d c7 ff ff       	call   80101ab0 <readi>
      if(n <= 0){
80105333:	83 c4 10             	add    $0x10,%esp
80105336:	85 c0                	test   %eax,%eax
80105338:	0f 8e 9e 00 00 00    	jle    801053dc <sys_open+0x14c>
        iunlockput(ip);
        end_op();
        return -1;
      }
      target[n] = '\0';
      iunlockput(ip);                    // drop current symlink inode
8010533e:	83 ec 0c             	sub    $0xc,%esp
      target[n] = '\0';
80105341:	c6 84 05 68 ff ff ff 	movb   $0x0,-0x98(%ebp,%eax,1)
80105348:	00 
      iunlockput(ip);                    // drop current symlink inode
80105349:	53                   	push   %ebx
8010534a:	e8 e1 c6 ff ff       	call   80101a30 <iunlockput>
      if((ip = namei(target)) == 0){
8010534f:	89 3c 24             	mov    %edi,(%esp)
80105352:	e8 29 cd ff ff       	call   80102080 <namei>
80105357:	83 c4 10             	add    $0x10,%esp
8010535a:	89 c3                	mov    %eax,%ebx
8010535c:	85 c0                	test   %eax,%eax
8010535e:	0f 84 0c 01 00 00    	je     80105470 <sys_open+0x1e0>
        end_op();
        return -1;
      }
      ilock(ip);
...
80105368:	e8 33 c4 ff ff       	call   801017a0 <ilock>
    while(ip->type == T_SYMLINK){
8010536d:	0f b7 43 50          	movzwl 0x50(%ebx),%eax
80105371:	83 c4 10             	add    $0x10,%esp
80105374:	66 83 f8 04          	cmp    $0x4,%ax
80105378:	0f 85 d2 00 00 00    	jne    80105450 <sys_open+0x1c0>
      if(++depth > MAXSYMLINK){          // cycle / chain too long
8010537e:	83 ee 01             	sub    $0x1,%esi
80105381:	75 a5                	jne    80105328 <sys_open+0x98>
80105383:	eb 57                	jmp    801053dc <sys_open+0x14c>
...
80105394:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
8010539a:	e8 61 f7 ff ff       	call   80104b00 <create>
    if(ip == 0){
...
801053a6:	0f 84 c4 00 00 00    	je     80105470 <sys_open+0x1e0>
      end_op();
      return -1;
    }
  }
...
801053ac:	e8 9f ba ff ff       	call   80100e50 <filealloc>
801053b1:	89 c7                	mov    %eax,%edi
801053b3:	85 c0                	test   %eax,%eax
801053b5:	74 25                	je     801053dc <sys_open+0x14c>
  struct proc *curproc = myproc();
801053b7:	e8 a4 e5 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801053bc:	31 f6                	xor    %esi,%esi
801053be:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
801053c0:	8b 54 b0 28          	mov    0x28(%eax,%esi,4),%edx
801053c4:	85 d2                	test   %edx,%edx
801053c6:	74 38                	je     80105400 <sys_open+0x170>
  for(fd = 0; fd < NOFILE; fd++){
801053c8:	83 c6 01             	add    $0x1,%esi
801053cb:	83 fe 10             	cmp    $0x10,%esi
801053ce:	75 f0                	jne    801053c0 <sys_open+0x130>
    if(f)
      fileclose(f);
...
801053ed:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
801053f0:	be ff ff ff ff       	mov    $0xffffffff,%esi
}
801053f5:	5b                   	pop    %ebx
...
80105400:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105403:	89 7c b0 28          	mov    %edi,0x28(%eax,%esi,4)
  iunlock(ip);
80105407:	53                   	push   %ebx
80105408:	e8 73 c4 ff ff       	call   80101880 <iunlock>
  end_op();
8010540d:	e8 9e d9 ff ff       	call   80102db0 <end_op>
  f->type     = FD_INODE;
80105412:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105418:	83 c4 10             	add    $0x10,%esp
  f->readable = !(omode & O_WRONLY);
8010541b:	8b 95 64 ff ff ff    	mov    -0x9c(%ebp),%edx
  f->ip       = ip;
80105421:	89 5f 10             	mov    %ebx,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80105424:	89 d0                	mov    %edx,%eax
  f->off      = 0;
80105426:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
8010542d:	f7 d0                	not    %eax
8010542f:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105432:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
80105435:	88 47 08             	mov    %al,0x8(%edi)
}
80105438:	89 f0                	mov    %esi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010543a:	0f 95 47 09          	setne  0x9(%edi)
}
...
80105444:	5d                   	pop    %ebp
80105445:	c3                   	ret
80105446:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010544d:	00 
8010544e:	66 90                	xchg   %ax,%ax
    if(ip->type == T_DIR && omode != O_RDONLY){
80105450:	66 83 f8 01          	cmp    $0x1,%ax
80105454:	0f 85 52 ff ff ff    	jne    801053ac <sys_open+0x11c>
8010545a:	8b 8d 64 ff ff ff    	mov    -0x9c(%ebp),%ecx
80105460:	85 c9                	test   %ecx,%ecx
80105462:	0f 84 44 ff ff ff    	je     801053ac <sys_open+0x11c>
80105468:	e9 6f ff ff ff       	jmp    801053dc <sys_open+0x14c>
8010546d:	8d 76 00             	lea    0x0(%esi),%esi
      end_op();
80105470:	e8 3b d9 ff ff       	call   80102db0 <end_op>
      return -1;
80105475:	e9 73 ff ff ff       	jmp    801053ed <sys_open+0x15d>
...
80105494:	e8 77 f5 ff ff       	call   80104a10 <argstr>
...
801054af:	e8 4c f6 ff ff       	call   80104b00 <create>
...
801054f4:	e8 17 f5 ff ff       	call   80104a10 <argstr>
...
80105509:	e8 42 f4 ff ff       	call   80104950 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010551e:	e8 2d f4 ff ff       	call   80104950 <argint>
     argint(1, &major) < 0 ||
...
8010553e:	e8 bd f5 ff ff       	call   80104b00 <create>
     argint(2, &minor) < 0 ||
...
8010558d:	e8 7e f4 ff ff       	call   80104a10 <argstr>
...
80105635:	e8 d6 f3 ff ff       	call   80104a10 <argstr>
...
80105651:	e8 fa f2 ff ff       	call   80104950 <argint>
...
80105670:	e8 2b f0 ff ff       	call   801046a0 <memset>
...
8010569a:	e8 21 f2 ff ff       	call   801048c0 <fetchint>
...
801056b8:	e8 43 f2 ff ff       	call   80104900 <fetchstr>
...
80105721:	e8 7a f2 ff ff       	call   801049a0 <argptr>
...
8010582c:	e8 1f f1 ff ff       	call   80104950 <argint>
...
8010587d:	e8 ce f0 ff ff       	call   80104950 <argint>
...
801058cd:	e8 7e f0 ff ff       	call   80104950 <argint>
...
801058dc:	68 80 3c 11 80       	push   $0x80113c80
801058e1:	e8 ba ec ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801058e6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801058e9:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
80105935:	e8 06 ec ff ff       	call   80104540 <release>
      return -1;
...
80105958:	e8 e3 eb ff ff       	call   80104540 <release>
}
...
801059d7:	c7 04 c5 c2 3c 11 80 	movl   $0x8e000008,-0x7feec33e(,%eax,8)
801059de:	08 00 00 8e 
801059e2:	66 89 14 c5 c0 3c 11 	mov    %dx,-0x7feec340(,%eax,8)
801059e9:	80 
801059ea:	c1 ea 10             	shr    $0x10,%edx
801059ed:	66 89 14 c5 c6 3c 11 	mov    %dx,-0x7feec33a(,%eax,8)
801059f4:	80 
  for(i = 0; i < 256; i++)
...
80105a07:	c7 05 c2 3e 11 80 08 	movl   $0xef000008,0x80113ec2
80105a0e:	00 00 ef 
  initlock(&tickslock, "time");
80105a11:	68 4e 77 10 80       	push   $0x8010774e
80105a16:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a1b:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
80105a21:	c1 e8 10             	shr    $0x10,%eax
80105a24:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
80105a2a:	e8 81 e9 ff ff       	call   801043b0 <initlock>
}
80105a2f:	83 c4 10             	add    $0x10,%esp
80105a32:	c9                   	leave
80105a33:	c3                   	ret
80105a34:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105a3b:	00 
...
80105a4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a4f:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
...
80105a82:	0f 84 30 01 00 00    	je     80105bb8 <trap+0x148>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105a88:	83 e8 0e             	sub    $0xe,%eax
80105a8b:	83 f8 31             	cmp    $0x31,%eax
80105a8e:	0f 87 8c 00 00 00    	ja     80105b20 <trap+0xb0>
80105a94:	ff 24 85 fc 7c 10 80 	jmp    *-0x7fef8304(,%eax,4)
80105a9b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105aa0:	e8 9b de ff ff       	call   80103940 <cpuid>
80105aa5:	85 c0                	test   %eax,%eax
80105aa7:	0f 84 63 02 00 00    	je     80105d10 <trap+0x2a0>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105aad:	e8 3e ce ff ff       	call   801028f0 <lapiceoi>
  }
...
80105ab2:	e8 a9 de ff ff       	call   80103960 <myproc>
80105ab7:	85 c0                	test   %eax,%eax
80105ab9:	74 1a                	je     80105ad5 <trap+0x65>
80105abb:	e8 a0 de ff ff       	call   80103960 <myproc>
80105ac0:	8b 50 24             	mov    0x24(%eax),%edx
80105ac3:	85 d2                	test   %edx,%edx
80105ac5:	74 0e                	je     80105ad5 <trap+0x65>
80105ac7:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105acb:	f7 d0                	not    %eax
80105acd:	a8 03                	test   $0x3,%al
80105acf:	0f 84 03 02 00 00    	je     80105cd8 <trap+0x268>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105ad5:	e8 86 de ff ff       	call   80103960 <myproc>
80105ada:	85 c0                	test   %eax,%eax
80105adc:	74 0f                	je     80105aed <trap+0x7d>
80105ade:	e8 7d de ff ff       	call   80103960 <myproc>
80105ae3:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105ae7:	0f 84 b3 00 00 00    	je     80105ba0 <trap+0x130>
...
80105af4:	74 1a                	je     80105b10 <trap+0xa0>
80105af6:	e8 65 de ff ff       	call   80103960 <myproc>
80105afb:	8b 40 24             	mov    0x24(%eax),%eax
80105afe:	85 c0                	test   %eax,%eax
80105b00:	74 0e                	je     80105b10 <trap+0xa0>
80105b02:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105b06:	f7 d0                	not    %eax
80105b08:	a8 03                	test   $0x3,%al
80105b0a:	0f 84 d5 00 00 00    	je     80105be5 <trap+0x175>
    exit();
}
...
80105b2a:	0f 84 14 02 00 00    	je     80105d44 <trap+0x2d4>
80105b30:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105b34:	0f 84 0a 02 00 00    	je     80105d44 <trap+0x2d4>
...
80105b59:	e8 02 de ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105b5e:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105b61:	51                   	push   %ecx
80105b62:	57                   	push   %edi
80105b63:	8b 55 dc             	mov    -0x24(%ebp),%edx
...
80105b75:	68 ec 79 10 80       	push   $0x801079ec
80105b7a:	e8 31 ab ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
80105b7f:	83 c4 20             	add    $0x20,%esp
80105b82:	e8 d9 dd ff ff       	call   80103960 <myproc>
80105b87:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b8e:	e8 cd dd ff ff       	call   80103960 <myproc>
80105b93:	85 c0                	test   %eax,%eax
80105b95:	0f 85 20 ff ff ff    	jne    80105abb <trap+0x4b>
80105b9b:	e9 35 ff ff ff       	jmp    80105ad5 <trap+0x65>
  if(myproc() && myproc()->state == RUNNING &&
80105ba0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ba4:	0f 85 43 ff ff ff    	jne    80105aed <trap+0x7d>
    yield();
80105baa:	e8 21 e4 ff ff       	call   80103fd0 <yield>
80105baf:	e9 39 ff ff ff       	jmp    80105aed <trap+0x7d>
...
80105bc2:	0f 85 20 01 00 00    	jne    80105ce8 <trap+0x278>
    myproc()->tf = tf;
80105bc8:	e8 93 dd ff ff       	call   80103960 <myproc>
80105bcd:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bd0:	e8 bb ee ff ff       	call   80104a90 <syscall>
    if(myproc()->killed)
80105bd5:	e8 86 dd ff ff       	call   80103960 <myproc>
80105bda:	8b 48 24             	mov    0x24(%eax),%ecx
80105bdd:	85 c9                	test   %ecx,%ecx
80105bdf:	0f 84 2b ff ff ff    	je     80105b10 <trap+0xa0>
}
80105be5:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105be8:	5b                   	pop    %ebx
80105be9:	5e                   	pop    %esi
80105bea:	5f                   	pop    %edi
80105beb:	5d                   	pop    %ebp
      exit();
80105bec:	e9 7f e1 ff ff       	jmp    80103d70 <exit>
...
80105c07:	68 44 79 10 80       	push   $0x80107944
...
80105c20:	0f 85 95 fe ff ff    	jne    80105abb <trap+0x4b>
80105c26:	e9 aa fe ff ff       	jmp    80105ad5 <trap+0x65>
80105c2b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c30:	e8 8b cb ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
80105c35:	e8 b6 cc ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c3a:	e8 21 dd ff ff       	call   80103960 <myproc>
80105c3f:	85 c0                	test   %eax,%eax
80105c41:	0f 85 74 fe ff ff    	jne    80105abb <trap+0x4b>
80105c47:	e9 89 fe ff ff       	jmp    80105ad5 <trap+0x65>
80105c4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105c50:	e8 ab 02 00 00       	call   80105f00 <uartintr>
    lapiceoi();
80105c55:	e8 96 cc ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c5a:	e8 01 dd ff ff       	call   80103960 <myproc>
80105c5f:	85 c0                	test   %eax,%eax
80105c61:	0f 85 54 fe ff ff    	jne    80105abb <trap+0x4b>
80105c67:	e9 69 fe ff ff       	jmp    80105ad5 <trap+0x65>
80105c6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105c70:	e8 bb c5 ff ff       	call   80102230 <ideintr>
80105c75:	e9 33 fe ff ff       	jmp    80105aad <trap+0x3d>
80105c7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105c80:	0f 20 d7             	mov    %cr2,%edi
    struct proc *p = myproc();
80105c83:	e8 d8 dc ff ff       	call   80103960 <myproc>
80105c88:	89 c6                	mov    %eax,%esi
    if((tf->cs & 3) == DPL_USER) {
80105c8a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c8e:	f7 d0                	not    %eax
80105c90:	a8 03                	test   $0x3,%al
80105c92:	0f 85 d4 00 00 00    	jne    80105d6c <trap+0x2fc>
      cprintf("pid %d %s: page fault va=0x%x eip=0x%x\n",
80105c98:	83 ec 0c             	sub    $0xc,%esp
             p->pid, p->name, va, tf->eip);
80105c9b:	8d 46 6c             	lea    0x6c(%esi),%eax
      cprintf("pid %d %s: page fault va=0x%x eip=0x%x\n",
80105c9e:	ff 73 38             	push   0x38(%ebx)
80105ca1:	57                   	push   %edi
80105ca2:	50                   	push   %eax
80105ca3:	ff 76 10             	push   0x10(%esi)
80105ca6:	68 68 79 10 80       	push   $0x80107968
80105cab:	e8 00 aa ff ff       	call   801006b0 <cprintf>
      if(va < PGSIZE)
80105cb0:	83 c4 20             	add    $0x20,%esp
80105cb3:	81 ff ff 0f 00 00    	cmp    $0xfff,%edi
80105cb9:	76 3d                	jbe    80105cf8 <trap+0x288>
      p->killed = 1;
80105cbb:	c7 46 24 01 00 00 00 	movl   $0x1,0x24(%esi)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cc2:	e8 99 dc ff ff       	call   80103960 <myproc>
80105cc7:	85 c0                	test   %eax,%eax
80105cc9:	0f 85 ec fd ff ff    	jne    80105abb <trap+0x4b>
80105ccf:	e9 01 fe ff ff       	jmp    80105ad5 <trap+0x65>
80105cd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105cd8:	e8 93 e0 ff ff       	call   80103d70 <exit>
80105cdd:	e9 f3 fd ff ff       	jmp    80105ad5 <trap+0x65>
80105ce2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105ce8:	e8 83 e0 ff ff       	call   80103d70 <exit>
80105ced:	e9 d6 fe ff ff       	jmp    80105bc8 <trap+0x158>
80105cf2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        cprintf("  (likely NULL pointer dereference)\n");
80105cf8:	83 ec 0c             	sub    $0xc,%esp
80105cfb:	68 90 79 10 80       	push   $0x80107990
80105d00:	e8 ab a9 ff ff       	call   801006b0 <cprintf>
80105d05:	83 c4 10             	add    $0x10,%esp
80105d08:	eb b1                	jmp    80105cbb <trap+0x24b>
80105d0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105d10:	83 ec 0c             	sub    $0xc,%esp
80105d13:	68 80 3c 11 80       	push   $0x80113c80
80105d18:	e8 83 e8 ff ff       	call   801045a0 <acquire>
      ticks++;
80105d1d:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105d24:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80105d2b:	e8 b0 e3 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105d30:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105d37:	e8 04 e8 ff ff       	call   80104540 <release>
80105d3c:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d3f:	e9 69 fd ff ff       	jmp    80105aad <trap+0x3d>
80105d44:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d47:	e8 f4 db ff ff       	call   80103940 <cpuid>
80105d4c:	83 ec 0c             	sub    $0xc,%esp
80105d4f:	56                   	push   %esi
80105d50:	57                   	push   %edi
80105d51:	50                   	push   %eax
80105d52:	ff 73 30             	push   0x30(%ebx)
80105d55:	68 b8 79 10 80       	push   $0x801079b8
80105d5a:	e8 51 a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105d5f:	83 c4 14             	add    $0x14,%esp
80105d62:	68 53 77 10 80       	push   $0x80107753
80105d67:	e8 14 a6 ff ff       	call   80100380 <panic>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d6c:	8b 73 38             	mov    0x38(%ebx),%esi
80105d6f:	e8 cc db ff ff       	call   80103940 <cpuid>
80105d74:	83 ec 0c             	sub    $0xc,%esp
80105d77:	57                   	push   %edi
80105d78:	56                   	push   %esi
80105d79:	eb d6                	jmp    80105d51 <trap+0x2e1>
...
80105da5:	c3                   	ret
80105da6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105dad:	00 
...
80105e07:	0f 84 7c 00 00 00    	je     80105e89 <uartinit+0xd9>
  uart = 1;
80105e0d:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105e14:	00 00 00 
80105e17:	89 fa                	mov    %edi,%edx
80105e19:	ec                   	in     (%dx),%al
80105e1a:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e1f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105e20:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e23:	bf 58 77 10 80       	mov    $0x80107758,%edi
80105e28:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105e2d:	6a 00                	push   $0x0
80105e2f:	6a 04                	push   $0x4
80105e31:	e8 2a c6 ff ff       	call   80102460 <ioapicenable>
80105e36:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105e39:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
80105e3d:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80105e40:	a1 c0 44 11 80       	mov    0x801144c0,%eax
80105e45:	85 c0                	test   %eax,%eax
80105e47:	74 32                	je     80105e7b <uartinit+0xcb>
80105e49:	89 f2                	mov    %esi,%edx
80105e4b:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105e4c:	a8 20                	test   $0x20,%al
80105e4e:	75 21                	jne    80105e71 <uartinit+0xc1>
80105e50:	bb 80 00 00 00       	mov    $0x80,%ebx
...
80105e68:	74 07                	je     80105e71 <uartinit+0xc1>
80105e6a:	89 f2                	mov    %esi,%edx
80105e6c:	ec                   	in     (%dx),%al
80105e6d:	a8 20                	test   $0x20,%al
80105e6f:	74 e7                	je     80105e58 <uartinit+0xa8>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e71:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e76:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105e7a:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105e7b:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105e7f:	83 c7 01             	add    $0x1,%edi
80105e82:	88 45 e7             	mov    %al,-0x19(%ebp)
80105e85:	84 c0                	test   %al,%al
80105e87:	75 b7                	jne    80105e40 <uartinit+0x90>
}
80105e89:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105e8c:	5b                   	pop    %ebx
80105e8d:	5e                   	pop    %esi
80105e8e:	5f                   	pop    %edi
80105e8f:	5d                   	pop    %ebp
80105e90:	c3                   	ret
80105e91:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105e98:	00 
...
80105ea7:	74 4f                	je     80105ef8 <uartputc+0x58>
{
80105ea9:	55                   	push   %ebp
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105eaa:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105eaf:	89 e5                	mov    %esp,%ebp
80105eb1:	56                   	push   %esi
80105eb2:	53                   	push   %ebx
80105eb3:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105eb4:	a8 20                	test   $0x20,%al
80105eb6:	75 29                	jne    80105ee1 <uartputc+0x41>
...
80105ecd:	e8 3e ca ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105ed2:	83 c4 10             	add    $0x10,%esp
80105ed5:	83 eb 01             	sub    $0x1,%ebx
80105ed8:	74 07                	je     80105ee1 <uartputc+0x41>
80105eda:	89 f2                	mov    %esi,%edx
80105edc:	ec                   	in     (%dx),%al
80105edd:	a8 20                	test   $0x20,%al
80105edf:	74 e7                	je     80105ec8 <uartputc+0x28>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105ee1:	8b 45 08             	mov    0x8(%ebp),%eax
80105ee4:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105ee9:	ee                   	out    %al,(%dx)
}
80105eea:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105eed:	5b                   	pop    %ebx
80105eee:	5e                   	pop    %esi
80105eef:	5d                   	pop    %ebp
80105ef0:	c3                   	ret
...
80105f06:	68 80 5d 10 80       	push   $0x80105d80
80105f0b:	e8 90 a9 ff ff       	call   801008a0 <consoleintr>
}
...
80105f17:	6a 00                	push   $0x0
  jmp alltraps
80105f19:	e9 7c fa ff ff       	jmp    8010599a <alltraps>
...
80105f20:	6a 01                	push   $0x1
  jmp alltraps
80105f22:	e9 73 fa ff ff       	jmp    8010599a <alltraps>
...
80105f29:	6a 02                	push   $0x2
  jmp alltraps
80105f2b:	e9 6a fa ff ff       	jmp    8010599a <alltraps>
...
80105f32:	6a 03                	push   $0x3
  jmp alltraps
80105f34:	e9 61 fa ff ff       	jmp    8010599a <alltraps>
...
80105f3b:	6a 04                	push   $0x4
  jmp alltraps
80105f3d:	e9 58 fa ff ff       	jmp    8010599a <alltraps>
...
80105f44:	6a 05                	push   $0x5
  jmp alltraps
80105f46:	e9 4f fa ff ff       	jmp    8010599a <alltraps>
...
80105f4d:	6a 06                	push   $0x6
  jmp alltraps
80105f4f:	e9 46 fa ff ff       	jmp    8010599a <alltraps>
...
80105f56:	6a 07                	push   $0x7
  jmp alltraps
80105f58:	e9 3d fa ff ff       	jmp    8010599a <alltraps>
...
80105f5d:	6a 08                	push   $0x8
  jmp alltraps
80105f5f:	e9 36 fa ff ff       	jmp    8010599a <alltraps>
...
80105f66:	6a 09                	push   $0x9
  jmp alltraps
80105f68:	e9 2d fa ff ff       	jmp    8010599a <alltraps>
...
80105f6d:	6a 0a                	push   $0xa
  jmp alltraps
80105f6f:	e9 26 fa ff ff       	jmp    8010599a <alltraps>
...
80105f74:	6a 0b                	push   $0xb
  jmp alltraps
80105f76:	e9 1f fa ff ff       	jmp    8010599a <alltraps>
...
80105f7b:	6a 0c                	push   $0xc
  jmp alltraps
80105f7d:	e9 18 fa ff ff       	jmp    8010599a <alltraps>
...
80105f82:	6a 0d                	push   $0xd
  jmp alltraps
80105f84:	e9 11 fa ff ff       	jmp    8010599a <alltraps>
...
80105fa2:	6a 11                	push   $0x11
  jmp alltraps
80105fa4:	e9 f1 f9 ff ff       	jmp    8010599a <alltraps>
...
80105fab:	6a 12                	push   $0x12
  jmp alltraps
80105fad:	e9 e8 f9 ff ff       	jmp    8010599a <alltraps>
...
80105fb4:	6a 13                	push   $0x13
  jmp alltraps
80105fb6:	e9 df f9 ff ff       	jmp    8010599a <alltraps>
...
80105fbd:	6a 14                	push   $0x14
  jmp alltraps
80105fbf:	e9 d6 f9 ff ff       	jmp    8010599a <alltraps>
...
80105fc6:	6a 15                	push   $0x15
  jmp alltraps
80105fc8:	e9 cd f9 ff ff       	jmp    8010599a <alltraps>
...
80105fcf:	6a 16                	push   $0x16
  jmp alltraps
80105fd1:	e9 c4 f9 ff ff       	jmp    8010599a <alltraps>
...
80105fd8:	6a 17                	push   $0x17
  jmp alltraps
80105fda:	e9 bb f9 ff ff       	jmp    8010599a <alltraps>
...
80105fe1:	6a 18                	push   $0x18
  jmp alltraps
80105fe3:	e9 b2 f9 ff ff       	jmp    8010599a <alltraps>
...
80105fea:	6a 19                	push   $0x19
  jmp alltraps
80105fec:	e9 a9 f9 ff ff       	jmp    8010599a <alltraps>
...
80105ff3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ff5:	e9 a0 f9 ff ff       	jmp    8010599a <alltraps>
...
80105ffc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ffe:	e9 97 f9 ff ff       	jmp    8010599a <alltraps>
...
80106005:	6a 1c                	push   $0x1c
  jmp alltraps
80106007:	e9 8e f9 ff ff       	jmp    8010599a <alltraps>
...
8010600e:	6a 1d                	push   $0x1d
  jmp alltraps
80106010:	e9 85 f9 ff ff       	jmp    8010599a <alltraps>
...
80106017:	6a 1e                	push   $0x1e
  jmp alltraps
80106019:	e9 7c f9 ff ff       	jmp    8010599a <alltraps>
...
80106020:	6a 1f                	push   $0x1f
  jmp alltraps
80106022:	e9 73 f9 ff ff       	jmp    8010599a <alltraps>
...
80106029:	6a 20                	push   $0x20
  jmp alltraps
8010602b:	e9 6a f9 ff ff       	jmp    8010599a <alltraps>
...
80106032:	6a 21                	push   $0x21
  jmp alltraps
80106034:	e9 61 f9 ff ff       	jmp    8010599a <alltraps>
...
8010603b:	6a 22                	push   $0x22
  jmp alltraps
8010603d:	e9 58 f9 ff ff       	jmp    8010599a <alltraps>
...
80106044:	6a 23                	push   $0x23
  jmp alltraps
80106046:	e9 4f f9 ff ff       	jmp    8010599a <alltraps>
...
8010604d:	6a 24                	push   $0x24
  jmp alltraps
8010604f:	e9 46 f9 ff ff       	jmp    8010599a <alltraps>
...
80106056:	6a 25                	push   $0x25
  jmp alltraps
80106058:	e9 3d f9 ff ff       	jmp    8010599a <alltraps>
...
8010605f:	6a 26                	push   $0x26
  jmp alltraps
80106061:	e9 34 f9 ff ff       	jmp    8010599a <alltraps>
...
80106068:	6a 27                	push   $0x27
  jmp alltraps
8010606a:	e9 2b f9 ff ff       	jmp    8010599a <alltraps>
...
80106071:	6a 28                	push   $0x28
  jmp alltraps
80106073:	e9 22 f9 ff ff       	jmp    8010599a <alltraps>
...
8010607a:	6a 29                	push   $0x29
  jmp alltraps
8010607c:	e9 19 f9 ff ff       	jmp    8010599a <alltraps>
...
80106083:	6a 2a                	push   $0x2a
  jmp alltraps
80106085:	e9 10 f9 ff ff       	jmp    8010599a <alltraps>
...
8010608c:	6a 2b                	push   $0x2b
  jmp alltraps
8010608e:	e9 07 f9 ff ff       	jmp    8010599a <alltraps>
...
80106095:	6a 2c                	push   $0x2c
  jmp alltraps
80106097:	e9 fe f8 ff ff       	jmp    8010599a <alltraps>
...
8010609e:	6a 2d                	push   $0x2d
  jmp alltraps
801060a0:	e9 f5 f8 ff ff       	jmp    8010599a <alltraps>
...
801060a7:	6a 2e                	push   $0x2e
  jmp alltraps
801060a9:	e9 ec f8 ff ff       	jmp    8010599a <alltraps>
...
801060b0:	6a 2f                	push   $0x2f
  jmp alltraps
801060b2:	e9 e3 f8 ff ff       	jmp    8010599a <alltraps>
...
801060b9:	6a 30                	push   $0x30
  jmp alltraps
801060bb:	e9 da f8 ff ff       	jmp    8010599a <alltraps>
...
801060c2:	6a 31                	push   $0x31
  jmp alltraps
801060c4:	e9 d1 f8 ff ff       	jmp    8010599a <alltraps>
...
801060cb:	6a 32                	push   $0x32
  jmp alltraps
801060cd:	e9 c8 f8 ff ff       	jmp    8010599a <alltraps>
...
801060d4:	6a 33                	push   $0x33
  jmp alltraps
801060d6:	e9 bf f8 ff ff       	jmp    8010599a <alltraps>
...
801060dd:	6a 34                	push   $0x34
  jmp alltraps
801060df:	e9 b6 f8 ff ff       	jmp    8010599a <alltraps>
...
801060e6:	6a 35                	push   $0x35
  jmp alltraps
801060e8:	e9 ad f8 ff ff       	jmp    8010599a <alltraps>
...
801060ef:	6a 36                	push   $0x36
  jmp alltraps
801060f1:	e9 a4 f8 ff ff       	jmp    8010599a <alltraps>
...
801060f8:	6a 37                	push   $0x37
  jmp alltraps
801060fa:	e9 9b f8 ff ff       	jmp    8010599a <alltraps>
...
80106101:	6a 38                	push   $0x38
  jmp alltraps
80106103:	e9 92 f8 ff ff       	jmp    8010599a <alltraps>
...
8010610a:	6a 39                	push   $0x39
  jmp alltraps
8010610c:	e9 89 f8 ff ff       	jmp    8010599a <alltraps>
...
80106113:	6a 3a                	push   $0x3a
  jmp alltraps
80106115:	e9 80 f8 ff ff       	jmp    8010599a <alltraps>
...
8010611c:	6a 3b                	push   $0x3b
  jmp alltraps
8010611e:	e9 77 f8 ff ff       	jmp    8010599a <alltraps>
...
80106125:	6a 3c                	push   $0x3c
  jmp alltraps
80106127:	e9 6e f8 ff ff       	jmp    8010599a <alltraps>
...
8010612e:	6a 3d                	push   $0x3d
  jmp alltraps
80106130:	e9 65 f8 ff ff       	jmp    8010599a <alltraps>
...
80106137:	6a 3e                	push   $0x3e
  jmp alltraps
80106139:	e9 5c f8 ff ff       	jmp    8010599a <alltraps>
...
80106140:	6a 3f                	push   $0x3f
  jmp alltraps
80106142:	e9 53 f8 ff ff       	jmp    8010599a <alltraps>
...
80106149:	6a 40                	push   $0x40
  jmp alltraps
8010614b:	e9 4a f8 ff ff       	jmp    8010599a <alltraps>
...
80106152:	6a 41                	push   $0x41
  jmp alltraps
80106154:	e9 41 f8 ff ff       	jmp    8010599a <alltraps>
...
8010615b:	6a 42                	push   $0x42
  jmp alltraps
8010615d:	e9 38 f8 ff ff       	jmp    8010599a <alltraps>
...
80106164:	6a 43                	push   $0x43
  jmp alltraps
80106166:	e9 2f f8 ff ff       	jmp    8010599a <alltraps>
...
8010616d:	6a 44                	push   $0x44
  jmp alltraps
8010616f:	e9 26 f8 ff ff       	jmp    8010599a <alltraps>
...
80106176:	6a 45                	push   $0x45
  jmp alltraps
80106178:	e9 1d f8 ff ff       	jmp    8010599a <alltraps>
...
8010617f:	6a 46                	push   $0x46
  jmp alltraps
80106181:	e9 14 f8 ff ff       	jmp    8010599a <alltraps>
...
80106188:	6a 47                	push   $0x47
  jmp alltraps
8010618a:	e9 0b f8 ff ff       	jmp    8010599a <alltraps>
...
80106191:	6a 48                	push   $0x48
  jmp alltraps
80106193:	e9 02 f8 ff ff       	jmp    8010599a <alltraps>
...
8010619a:	6a 49                	push   $0x49
  jmp alltraps
8010619c:	e9 f9 f7 ff ff       	jmp    8010599a <alltraps>
...
801061a3:	6a 4a                	push   $0x4a
  jmp alltraps
801061a5:	e9 f0 f7 ff ff       	jmp    8010599a <alltraps>
...
801061ac:	6a 4b                	push   $0x4b
  jmp alltraps
801061ae:	e9 e7 f7 ff ff       	jmp    8010599a <alltraps>
...
801061b5:	6a 4c                	push   $0x4c
  jmp alltraps
801061b7:	e9 de f7 ff ff       	jmp    8010599a <alltraps>
...
801061be:	6a 4d                	push   $0x4d
  jmp alltraps
801061c0:	e9 d5 f7 ff ff       	jmp    8010599a <alltraps>
...
801061c7:	6a 4e                	push   $0x4e
  jmp alltraps
801061c9:	e9 cc f7 ff ff       	jmp    8010599a <alltraps>
...
801061d0:	6a 4f                	push   $0x4f
  jmp alltraps
801061d2:	e9 c3 f7 ff ff       	jmp    8010599a <alltraps>
...
801061d9:	6a 50                	push   $0x50
  jmp alltraps
801061db:	e9 ba f7 ff ff       	jmp    8010599a <alltraps>
...
801061e2:	6a 51                	push   $0x51
  jmp alltraps
801061e4:	e9 b1 f7 ff ff       	jmp    8010599a <alltraps>
...
801061eb:	6a 52                	push   $0x52
  jmp alltraps
801061ed:	e9 a8 f7 ff ff       	jmp    8010599a <alltraps>
...
801061f4:	6a 53                	push   $0x53
  jmp alltraps
801061f6:	e9 9f f7 ff ff       	jmp    8010599a <alltraps>
...
801061fd:	6a 54                	push   $0x54
  jmp alltraps
801061ff:	e9 96 f7 ff ff       	jmp    8010599a <alltraps>
...
80106206:	6a 55                	push   $0x55
  jmp alltraps
80106208:	e9 8d f7 ff ff       	jmp    8010599a <alltraps>
...
8010620f:	6a 56                	push   $0x56
  jmp alltraps
80106211:	e9 84 f7 ff ff       	jmp    8010599a <alltraps>
...
80106218:	6a 57                	push   $0x57
  jmp alltraps
8010621a:	e9 7b f7 ff ff       	jmp    8010599a <alltraps>
...
80106221:	6a 58                	push   $0x58
  jmp alltraps
80106223:	e9 72 f7 ff ff       	jmp    8010599a <alltraps>
...
8010622a:	6a 59                	push   $0x59
  jmp alltraps
8010622c:	e9 69 f7 ff ff       	jmp    8010599a <alltraps>
...
80106233:	6a 5a                	push   $0x5a
  jmp alltraps
80106235:	e9 60 f7 ff ff       	jmp    8010599a <alltraps>
...
8010623c:	6a 5b                	push   $0x5b
  jmp alltraps
8010623e:	e9 57 f7 ff ff       	jmp    8010599a <alltraps>
...
80106245:	6a 5c                	push   $0x5c
  jmp alltraps
80106247:	e9 4e f7 ff ff       	jmp    8010599a <alltraps>
...
8010624e:	6a 5d                	push   $0x5d
  jmp alltraps
80106250:	e9 45 f7 ff ff       	jmp    8010599a <alltraps>
...
80106257:	6a 5e                	push   $0x5e
  jmp alltraps
80106259:	e9 3c f7 ff ff       	jmp    8010599a <alltraps>
...
80106260:	6a 5f                	push   $0x5f
  jmp alltraps
80106262:	e9 33 f7 ff ff       	jmp    8010599a <alltraps>
...
80106269:	6a 60                	push   $0x60
  jmp alltraps
8010626b:	e9 2a f7 ff ff       	jmp    8010599a <alltraps>
...
80106272:	6a 61                	push   $0x61
  jmp alltraps
80106274:	e9 21 f7 ff ff       	jmp    8010599a <alltraps>
...
8010627b:	6a 62                	push   $0x62
  jmp alltraps
8010627d:	e9 18 f7 ff ff       	jmp    8010599a <alltraps>
...
80106284:	6a 63                	push   $0x63
  jmp alltraps
80106286:	e9 0f f7 ff ff       	jmp    8010599a <alltraps>
...
8010628d:	6a 64                	push   $0x64
  jmp alltraps
8010628f:	e9 06 f7 ff ff       	jmp    8010599a <alltraps>
...
80106296:	6a 65                	push   $0x65
  jmp alltraps
80106298:	e9 fd f6 ff ff       	jmp    8010599a <alltraps>
...
8010629f:	6a 66                	push   $0x66
  jmp alltraps
801062a1:	e9 f4 f6 ff ff       	jmp    8010599a <alltraps>
...
801062a8:	6a 67                	push   $0x67
  jmp alltraps
801062aa:	e9 eb f6 ff ff       	jmp    8010599a <alltraps>
...
801062b1:	6a 68                	push   $0x68
  jmp alltraps
801062b3:	e9 e2 f6 ff ff       	jmp    8010599a <alltraps>
...
801062ba:	6a 69                	push   $0x69
  jmp alltraps
801062bc:	e9 d9 f6 ff ff       	jmp    8010599a <alltraps>
...
801062c3:	6a 6a                	push   $0x6a
  jmp alltraps
801062c5:	e9 d0 f6 ff ff       	jmp    8010599a <alltraps>
...
801062cc:	6a 6b                	push   $0x6b
  jmp alltraps
801062ce:	e9 c7 f6 ff ff       	jmp    8010599a <alltraps>
...
801062d5:	6a 6c                	push   $0x6c
  jmp alltraps
801062d7:	e9 be f6 ff ff       	jmp    8010599a <alltraps>
...
801062de:	6a 6d                	push   $0x6d
  jmp alltraps
801062e0:	e9 b5 f6 ff ff       	jmp    8010599a <alltraps>
...
801062e7:	6a 6e                	push   $0x6e
  jmp alltraps
801062e9:	e9 ac f6 ff ff       	jmp    8010599a <alltraps>
...
801062f0:	6a 6f                	push   $0x6f
  jmp alltraps
801062f2:	e9 a3 f6 ff ff       	jmp    8010599a <alltraps>
...
801062f9:	6a 70                	push   $0x70
  jmp alltraps
801062fb:	e9 9a f6 ff ff       	jmp    8010599a <alltraps>
...
80106302:	6a 71                	push   $0x71
  jmp alltraps
80106304:	e9 91 f6 ff ff       	jmp    8010599a <alltraps>
...
8010630b:	6a 72                	push   $0x72
  jmp alltraps
8010630d:	e9 88 f6 ff ff       	jmp    8010599a <alltraps>
...
80106314:	6a 73                	push   $0x73
  jmp alltraps
80106316:	e9 7f f6 ff ff       	jmp    8010599a <alltraps>
...
8010631d:	6a 74                	push   $0x74
  jmp alltraps
8010631f:	e9 76 f6 ff ff       	jmp    8010599a <alltraps>
...
80106326:	6a 75                	push   $0x75
  jmp alltraps
80106328:	e9 6d f6 ff ff       	jmp    8010599a <alltraps>
...
8010632f:	6a 76                	push   $0x76
  jmp alltraps
80106331:	e9 64 f6 ff ff       	jmp    8010599a <alltraps>
...
80106338:	6a 77                	push   $0x77
  jmp alltraps
8010633a:	e9 5b f6 ff ff       	jmp    8010599a <alltraps>
...
80106341:	6a 78                	push   $0x78
  jmp alltraps
80106343:	e9 52 f6 ff ff       	jmp    8010599a <alltraps>
...
8010634a:	6a 79                	push   $0x79
  jmp alltraps
8010634c:	e9 49 f6 ff ff       	jmp    8010599a <alltraps>
...
80106353:	6a 7a                	push   $0x7a
  jmp alltraps
80106355:	e9 40 f6 ff ff       	jmp    8010599a <alltraps>
...
8010635c:	6a 7b                	push   $0x7b
  jmp alltraps
8010635e:	e9 37 f6 ff ff       	jmp    8010599a <alltraps>
...
80106365:	6a 7c                	push   $0x7c
  jmp alltraps
80106367:	e9 2e f6 ff ff       	jmp    8010599a <alltraps>
...
8010636e:	6a 7d                	push   $0x7d
  jmp alltraps
80106370:	e9 25 f6 ff ff       	jmp    8010599a <alltraps>
...
80106377:	6a 7e                	push   $0x7e
  jmp alltraps
80106379:	e9 1c f6 ff ff       	jmp    8010599a <alltraps>
...
80106380:	6a 7f                	push   $0x7f
  jmp alltraps
80106382:	e9 13 f6 ff ff       	jmp    8010599a <alltraps>
...
80106389:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010638e:	e9 07 f6 ff ff       	jmp    8010599a <alltraps>
...
80106395:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010639a:	e9 fb f5 ff ff       	jmp    8010599a <alltraps>
...
801063a1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063a6:	e9 ef f5 ff ff       	jmp    8010599a <alltraps>
...
801063ad:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063b2:	e9 e3 f5 ff ff       	jmp    8010599a <alltraps>
...
801063b9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063be:	e9 d7 f5 ff ff       	jmp    8010599a <alltraps>
...
801063c5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063ca:	e9 cb f5 ff ff       	jmp    8010599a <alltraps>
...
801063d1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063d6:	e9 bf f5 ff ff       	jmp    8010599a <alltraps>
...
801063dd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063e2:	e9 b3 f5 ff ff       	jmp    8010599a <alltraps>
...
801063e9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063ee:	e9 a7 f5 ff ff       	jmp    8010599a <alltraps>
...
801063f5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063fa:	e9 9b f5 ff ff       	jmp    8010599a <alltraps>
...
80106401:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106406:	e9 8f f5 ff ff       	jmp    8010599a <alltraps>
...
8010640d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106412:	e9 83 f5 ff ff       	jmp    8010599a <alltraps>
...
80106419:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010641e:	e9 77 f5 ff ff       	jmp    8010599a <alltraps>
...
80106425:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010642a:	e9 6b f5 ff ff       	jmp    8010599a <alltraps>
...
80106431:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106436:	e9 5f f5 ff ff       	jmp    8010599a <alltraps>
...
8010643d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106442:	e9 53 f5 ff ff       	jmp    8010599a <alltraps>
...
80106449:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010644e:	e9 47 f5 ff ff       	jmp    8010599a <alltraps>
...
80106455:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010645a:	e9 3b f5 ff ff       	jmp    8010599a <alltraps>
...
80106461:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106466:	e9 2f f5 ff ff       	jmp    8010599a <alltraps>
...
8010646d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106472:	e9 23 f5 ff ff       	jmp    8010599a <alltraps>
...
80106479:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010647e:	e9 17 f5 ff ff       	jmp    8010599a <alltraps>
...
80106485:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010648a:	e9 0b f5 ff ff       	jmp    8010599a <alltraps>
...
80106491:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106496:	e9 ff f4 ff ff       	jmp    8010599a <alltraps>
...
8010649d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064a2:	e9 f3 f4 ff ff       	jmp    8010599a <alltraps>
...
801064a9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064ae:	e9 e7 f4 ff ff       	jmp    8010599a <alltraps>
...
801064b5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ba:	e9 db f4 ff ff       	jmp    8010599a <alltraps>
...
801064c1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064c6:	e9 cf f4 ff ff       	jmp    8010599a <alltraps>
...
801064cd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064d2:	e9 c3 f4 ff ff       	jmp    8010599a <alltraps>
...
801064d9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064de:	e9 b7 f4 ff ff       	jmp    8010599a <alltraps>
...
801064e5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064ea:	e9 ab f4 ff ff       	jmp    8010599a <alltraps>
...
801064f1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064f6:	e9 9f f4 ff ff       	jmp    8010599a <alltraps>
...
801064fd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106502:	e9 93 f4 ff ff       	jmp    8010599a <alltraps>
...
80106509:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010650e:	e9 87 f4 ff ff       	jmp    8010599a <alltraps>
...
80106515:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010651a:	e9 7b f4 ff ff       	jmp    8010599a <alltraps>
...
80106521:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106526:	e9 6f f4 ff ff       	jmp    8010599a <alltraps>
...
8010652d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106532:	e9 63 f4 ff ff       	jmp    8010599a <alltraps>
...
80106539:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010653e:	e9 57 f4 ff ff       	jmp    8010599a <alltraps>
...
80106545:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010654a:	e9 4b f4 ff ff       	jmp    8010599a <alltraps>
...
80106551:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106556:	e9 3f f4 ff ff       	jmp    8010599a <alltraps>
...
8010655d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106562:	e9 33 f4 ff ff       	jmp    8010599a <alltraps>
...
80106569:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010656e:	e9 27 f4 ff ff       	jmp    8010599a <alltraps>
...
80106575:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010657a:	e9 1b f4 ff ff       	jmp    8010599a <alltraps>
...
80106581:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106586:	e9 0f f4 ff ff       	jmp    8010599a <alltraps>
...
8010658d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106592:	e9 03 f4 ff ff       	jmp    8010599a <alltraps>
...
80106599:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010659e:	e9 f7 f3 ff ff       	jmp    8010599a <alltraps>
...
801065a5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065aa:	e9 eb f3 ff ff       	jmp    8010599a <alltraps>
...
801065b1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065b6:	e9 df f3 ff ff       	jmp    8010599a <alltraps>
...
801065bd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065c2:	e9 d3 f3 ff ff       	jmp    8010599a <alltraps>
...
801065c9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065ce:	e9 c7 f3 ff ff       	jmp    8010599a <alltraps>
...
801065d5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065da:	e9 bb f3 ff ff       	jmp    8010599a <alltraps>
...
801065e1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065e6:	e9 af f3 ff ff       	jmp    8010599a <alltraps>
...
801065ed:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065f2:	e9 a3 f3 ff ff       	jmp    8010599a <alltraps>
...
801065f9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801065fe:	e9 97 f3 ff ff       	jmp    8010599a <alltraps>
...
80106605:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010660a:	e9 8b f3 ff ff       	jmp    8010599a <alltraps>
...
80106611:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106616:	e9 7f f3 ff ff       	jmp    8010599a <alltraps>
...
8010661d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106622:	e9 73 f3 ff ff       	jmp    8010599a <alltraps>
...
80106629:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010662e:	e9 67 f3 ff ff       	jmp    8010599a <alltraps>
...
80106635:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010663a:	e9 5b f3 ff ff       	jmp    8010599a <alltraps>
...
80106641:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106646:	e9 4f f3 ff ff       	jmp    8010599a <alltraps>
...
8010664d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106652:	e9 43 f3 ff ff       	jmp    8010599a <alltraps>
...
80106659:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010665e:	e9 37 f3 ff ff       	jmp    8010599a <alltraps>
...
80106665:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010666a:	e9 2b f3 ff ff       	jmp    8010599a <alltraps>
...
80106671:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106676:	e9 1f f3 ff ff       	jmp    8010599a <alltraps>
...
8010667d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106682:	e9 13 f3 ff ff       	jmp    8010599a <alltraps>
...
80106689:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010668e:	e9 07 f3 ff ff       	jmp    8010599a <alltraps>
...
80106695:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010669a:	e9 fb f2 ff ff       	jmp    8010599a <alltraps>
...
801066a1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066a6:	e9 ef f2 ff ff       	jmp    8010599a <alltraps>
...
801066ad:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066b2:	e9 e3 f2 ff ff       	jmp    8010599a <alltraps>
...
801066b9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066be:	e9 d7 f2 ff ff       	jmp    8010599a <alltraps>
...
801066c5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066ca:	e9 cb f2 ff ff       	jmp    8010599a <alltraps>
...
801066d1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066d6:	e9 bf f2 ff ff       	jmp    8010599a <alltraps>
...
801066dd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066e2:	e9 b3 f2 ff ff       	jmp    8010599a <alltraps>
...
801066e9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066ee:	e9 a7 f2 ff ff       	jmp    8010599a <alltraps>
...
801066f5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066fa:	e9 9b f2 ff ff       	jmp    8010599a <alltraps>
...
80106701:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106706:	e9 8f f2 ff ff       	jmp    8010599a <alltraps>
...
8010670d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106712:	e9 83 f2 ff ff       	jmp    8010599a <alltraps>
...
80106719:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010671e:	e9 77 f2 ff ff       	jmp    8010599a <alltraps>
...
80106725:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010672a:	e9 6b f2 ff ff       	jmp    8010599a <alltraps>
...
80106731:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106736:	e9 5f f2 ff ff       	jmp    8010599a <alltraps>
...
8010673d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106742:	e9 53 f2 ff ff       	jmp    8010599a <alltraps>
...
80106749:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010674e:	e9 47 f2 ff ff       	jmp    8010599a <alltraps>
...
80106755:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010675a:	e9 3b f2 ff ff       	jmp    8010599a <alltraps>
...
80106761:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106766:	e9 2f f2 ff ff       	jmp    8010599a <alltraps>
...
8010676d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106772:	e9 23 f2 ff ff       	jmp    8010599a <alltraps>
...
80106779:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010677e:	e9 17 f2 ff ff       	jmp    8010599a <alltraps>
...
80106785:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010678a:	e9 0b f2 ff ff       	jmp    8010599a <alltraps>
...
80106791:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106796:	e9 ff f1 ff ff       	jmp    8010599a <alltraps>
...
8010679d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067a2:	e9 f3 f1 ff ff       	jmp    8010599a <alltraps>
...
801067a9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067ae:	e9 e7 f1 ff ff       	jmp    8010599a <alltraps>
...
801067b5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ba:	e9 db f1 ff ff       	jmp    8010599a <alltraps>
...
801067c1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067c6:	e9 cf f1 ff ff       	jmp    8010599a <alltraps>
...
801067cd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067d2:	e9 c3 f1 ff ff       	jmp    8010599a <alltraps>
...
801067d9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067de:	e9 b7 f1 ff ff       	jmp    8010599a <alltraps>
...
801067e5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067ea:	e9 ab f1 ff ff       	jmp    8010599a <alltraps>
...
801067f1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067f6:	e9 9f f1 ff ff       	jmp    8010599a <alltraps>
...
801067fd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106802:	e9 93 f1 ff ff       	jmp    8010599a <alltraps>
...
80106809:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010680e:	e9 87 f1 ff ff       	jmp    8010599a <alltraps>
...
80106815:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010681a:	e9 7b f1 ff ff       	jmp    8010599a <alltraps>
...
80106821:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106826:	e9 6f f1 ff ff       	jmp    8010599a <alltraps>
...
8010682d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106832:	e9 63 f1 ff ff       	jmp    8010599a <alltraps>
...
80106839:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010683e:	e9 57 f1 ff ff       	jmp    8010599a <alltraps>
...
80106845:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010684a:	e9 4b f1 ff ff       	jmp    8010599a <alltraps>
...
80106851:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106856:	e9 3f f1 ff ff       	jmp    8010599a <alltraps>
...
8010685d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106862:	e9 33 f1 ff ff       	jmp    8010599a <alltraps>
...
80106869:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010686e:	e9 27 f1 ff ff       	jmp    8010599a <alltraps>
...
80106875:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010687a:	e9 1b f1 ff ff       	jmp    8010599a <alltraps>
...
80106881:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106886:	e9 0f f1 ff ff       	jmp    8010599a <alltraps>
...
8010688d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106892:	e9 03 f1 ff ff       	jmp    8010599a <alltraps>
...
80106899:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010689e:	e9 f7 f0 ff ff       	jmp    8010599a <alltraps>
...
801068a5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068aa:	e9 eb f0 ff ff       	jmp    8010599a <alltraps>
...
801068b1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068b6:	e9 df f0 ff ff       	jmp    8010599a <alltraps>
...
801068bd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068c2:	e9 d3 f0 ff ff       	jmp    8010599a <alltraps>
...
801068c9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068ce:	e9 c7 f0 ff ff       	jmp    8010599a <alltraps>
...
801068d5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068da:	e9 bb f0 ff ff       	jmp    8010599a <alltraps>
...
801068e1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068e6:	e9 af f0 ff ff       	jmp    8010599a <alltraps>
...
801068ed:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068f2:	e9 a3 f0 ff ff       	jmp    8010599a <alltraps>
...
801068f9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801068fe:	e9 97 f0 ff ff       	jmp    8010599a <alltraps>
...
80106905:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010690a:	e9 8b f0 ff ff       	jmp    8010599a <alltraps>
...
80106911:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106916:	e9 7f f0 ff ff       	jmp    8010599a <alltraps>
...
8010691d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106922:	e9 73 f0 ff ff       	jmp    8010599a <alltraps>
...
80106929:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010692e:	e9 67 f0 ff ff       	jmp    8010599a <alltraps>
...
80106935:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010693a:	e9 5b f0 ff ff       	jmp    8010599a <alltraps>
...
80106941:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106946:	e9 4f f0 ff ff       	jmp    8010599a <alltraps>
...
8010694d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106952:	e9 43 f0 ff ff       	jmp    8010599a <alltraps>
...
80106959:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010695e:	e9 37 f0 ff ff       	jmp    8010599a <alltraps>
...
80106965:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010696a:	e9 2b f0 ff ff       	jmp    8010599a <alltraps>
...
80106971:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106976:	e9 1f f0 ff ff       	jmp    8010599a <alltraps>
...
8010697d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106982:	e9 13 f0 ff ff       	jmp    8010599a <alltraps>
...
801069a5:	39 d3                	cmp    %edx,%ebx
801069a7:	73 56                	jae    801069ff <deallocuvm.part.0+0x6f>
801069a9:	89 4d e0             	mov    %ecx,-0x20(%ebp)
801069ac:	89 c6                	mov    %eax,%esi
801069ae:	89 d7                	mov    %edx,%edi
801069b0:	eb 12                	jmp    801069c4 <deallocuvm.part.0+0x34>
801069b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801069b8:	83 c2 01             	add    $0x1,%edx
801069bb:	89 d3                	mov    %edx,%ebx
801069bd:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
801069c0:	39 fb                	cmp    %edi,%ebx
801069c2:	73 38                	jae    801069fc <deallocuvm.part.0+0x6c>
  pde = &pgdir[PDX(va)];
801069c4:	89 da                	mov    %ebx,%edx
801069c6:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
801069c9:	8b 04 96             	mov    (%esi,%edx,4),%eax
801069cc:	a8 01                	test   $0x1,%al
801069ce:	74 e8                	je     801069b8 <deallocuvm.part.0+0x28>
  return &pgtab[PTX(va)];
801069d0:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801069d2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
801069d7:	c1 e9 0a             	shr    $0xa,%ecx
801069da:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
801069e0:	8d 84 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%eax
    if(!pte)
801069e7:	85 c0                	test   %eax,%eax
801069e9:	74 cd                	je     801069b8 <deallocuvm.part.0+0x28>
    else if((*pte & PTE_P) != 0){
801069eb:	8b 10                	mov    (%eax),%edx
801069ed:	f6 c2 01             	test   $0x1,%dl
801069f0:	75 1e                	jne    80106a10 <deallocuvm.part.0+0x80>
  for(; a  < oldsz; a += PGSIZE){
801069f2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069f8:	39 fb                	cmp    %edi,%ebx
801069fa:	72 c8                	jb     801069c4 <deallocuvm.part.0+0x34>
801069fc:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      kfree(v);
      *pte = 0;
    }
  }
...
801069ff:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80106a09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(pa == 0)
80106a10:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106a16:	74 26                	je     80106a3e <deallocuvm.part.0+0xae>
      kfree(v);
80106a18:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106a1b:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106a21:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106a24:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106a2a:	52                   	push   %edx
80106a2b:	e8 70 ba ff ff       	call   801024a0 <kfree>
      *pte = 0;
80106a30:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(; a  < oldsz; a += PGSIZE){
80106a33:	83 c4 10             	add    $0x10,%esp
      *pte = 0;
80106a36:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106a3c:	eb 82                	jmp    801069c0 <deallocuvm.part.0+0x30>
        panic("kfree");
80106a3e:	83 ec 0c             	sub    $0xc,%esp
80106a41:	68 2c 75 10 80       	push   $0x8010752c
80106a46:	e8 35 99 ff ff       	call   80100380 <panic>
80106a4b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
80106a61:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106a64:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80106a68:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106a6d:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106a70:	8b 45 08             	mov    0x8(%ebp),%eax
80106a73:	29 d8                	sub    %ebx,%eax
80106a75:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a78:	eb 3f                	jmp    80106ab9 <mappages+0x69>
...
80106a82:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80106a87:	c1 ea 0a             	shr    $0xa,%edx
80106a8a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106a90:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106a97:	85 c0                	test   %eax,%eax
80106a99:	74 75                	je     80106b10 <mappages+0xc0>
    if(*pte & PTE_P)
80106a9b:	f6 00 01             	testb  $0x1,(%eax)
80106a9e:	0f 85 86 00 00 00    	jne    80106b2a <mappages+0xda>
    *pte = pa | perm | PTE_P;
80106aa4:	0b 75 0c             	or     0xc(%ebp),%esi
80106aa7:	83 ce 01             	or     $0x1,%esi
80106aaa:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106aac:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106aaf:	39 c3                	cmp    %eax,%ebx
80106ab1:	74 6d                	je     80106b20 <mappages+0xd0>
    a += PGSIZE;
80106ab3:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106ab9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106abc:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106abf:	8d 34 03             	lea    (%ebx,%eax,1),%esi
80106ac2:	89 d8                	mov    %ebx,%eax
80106ac4:	c1 e8 16             	shr    $0x16,%eax
80106ac7:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106aca:	8b 07                	mov    (%edi),%eax
80106acc:	a8 01                	test   $0x1,%al
80106ace:	75 b0                	jne    80106a80 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106ad0:	e8 8b bb ff ff       	call   80102660 <kalloc>
80106ad5:	85 c0                	test   %eax,%eax
80106ad7:	74 37                	je     80106b10 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106ad9:	83 ec 04             	sub    $0x4,%esp
80106adc:	68 00 10 00 00       	push   $0x1000
80106ae1:	6a 00                	push   $0x0
80106ae3:	50                   	push   %eax
80106ae4:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106ae7:	e8 b4 db ff ff       	call   801046a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106aec:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106aef:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106af2:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106af8:	83 c8 07             	or     $0x7,%eax
80106afb:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106afd:	89 d8                	mov    %ebx,%eax
80106aff:	c1 e8 0a             	shr    $0xa,%eax
80106b02:	25 fc 0f 00 00       	and    $0xffc,%eax
80106b07:	01 d0                	add    %edx,%eax
80106b09:	eb 90                	jmp    80106a9b <mappages+0x4b>
80106b0b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
}
...
80106b2d:	68 60 77 10 80       	push   $0x80107760
80106b32:	e8 49 98 ff ff       	call   80100380 <panic>
...
80106b5a:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
80106b61:	ff 00 00 
80106b64:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
80106b6b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b6e:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
80106b75:	ff 00 00 
80106b78:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
80106b7f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b82:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
80106b89:	ff 00 00 
80106b8c:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
80106b93:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b96:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
80106b9d:	ff 00 00 
80106ba0:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
80106ba7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106baa:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
80106bc0:	c9                   	leave
80106bc1:	c3                   	ret
80106bc2:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106bc9:	00 
80106bca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80106bd0 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106bd0:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106bf9:	0f 84 da 00 00 00    	je     80106cd9 <switchuvm+0xf9>
  if(p->pgdir == 0)
80106bff:	8b 46 04             	mov    0x4(%esi),%eax
80106c02:	85 c0                	test   %eax,%eax
80106c04:	0f 84 c2 00 00 00    	je     80106ccc <switchuvm+0xec>
  pushcli();
80106c0a:	e8 41 d8 ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c0f:	e8 cc cc ff ff       	call   801038e0 <mycpu>
80106c14:	89 c3                	mov    %eax,%ebx
80106c16:	e8 c5 cc ff ff       	call   801038e0 <mycpu>
80106c1b:	89 c7                	mov    %eax,%edi
80106c1d:	e8 be cc ff ff       	call   801038e0 <mycpu>
80106c22:	83 c7 08             	add    $0x8,%edi
80106c25:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c28:	e8 b3 cc ff ff       	call   801038e0 <mycpu>
80106c2d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106c30:	ba 67 00 00 00       	mov    $0x67,%edx
80106c35:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106c3c:	83 c0 08             	add    $0x8,%eax
80106c3f:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
...
80106c54:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106c5a:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106c60:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106c65:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c6c:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106c71:	e8 6a cc ff ff       	call   801038e0 <mycpu>
80106c76:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c7d:	e8 5e cc ff ff       	call   801038e0 <mycpu>
80106c82:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106c86:	8b 5e 08             	mov    0x8(%esi),%ebx
80106c89:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c8f:	e8 4c cc ff ff       	call   801038e0 <mycpu>
80106c94:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c97:	e8 44 cc ff ff       	call   801038e0 <mycpu>
80106c9c:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106ca0:	b8 28 00 00 00       	mov    $0x28,%eax
80106ca5:	0f 00 d8             	ltr    %eax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106ca8:	8b 46 04             	mov    0x4(%esi),%eax
...
80106cb9:	5d                   	pop    %ebp
  popcli();
80106cba:	e9 e1 d7 ff ff       	jmp    801044a0 <popcli>
    panic("switchuvm: no process");
80106cbf:	83 ec 0c             	sub    $0xc,%esp
80106cc2:	68 66 77 10 80       	push   $0x80107766
80106cc7:	e8 b4 96 ff ff       	call   80100380 <panic>
    panic("switchuvm: no pgdir");
80106ccc:	83 ec 0c             	sub    $0xc,%esp
80106ccf:	68 91 77 10 80       	push   $0x80107791
80106cd4:	e8 a7 96 ff ff       	call   80100380 <panic>
    panic("switchuvm: no kstack");
80106cd9:	83 ec 0c             	sub    $0xc,%esp
80106cdc:	68 7c 77 10 80       	push   $0x8010777c
80106ce1:	e8 9a 96 ff ff       	call   80100380 <panic>
...
80106d0b:	77 49                	ja     80106d56 <inituvm+0x66>
  mem = kalloc();
80106d0d:	e8 4e b9 ff ff       	call   80102660 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106d39:	e8 12 fd ff ff       	call   80106a50 <mappages>
  memmove(mem, init, sz);
80106d3e:	83 c4 10             	add    $0x10,%esp
80106d41:	89 75 10             	mov    %esi,0x10(%ebp)
...
80106d50:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d51:	e9 da d9 ff ff       	jmp    80104730 <memmove>
    panic("inituvm: more than a page");
80106d56:	83 ec 0c             	sub    $0xc,%esp
80106d59:	68 a5 77 10 80       	push   $0x801077a5
80106d5e:	e8 1d 96 ff ff       	call   80100380 <panic>
80106d63:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106d6a:	00 
...
80106d79:	8b 75 0c             	mov    0xc(%ebp),%esi
{
80106d7c:	8b 7d 18             	mov    0x18(%ebp),%edi
  if((uint) addr % PGSIZE != 0)
80106d7f:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106d85:	0f 85 a2 00 00 00    	jne    80106e2d <loaduvm+0xbd>
  for(i = 0; i < sz; i += PGSIZE){
80106d8b:	85 ff                	test   %edi,%edi
80106d8d:	74 7d                	je     80106e0c <loaduvm+0x9c>
80106d8f:	90                   	nop
  pde = &pgdir[PDX(va)];
80106d90:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80106d93:	8b 55 08             	mov    0x8(%ebp),%edx
80106d96:	01 f0                	add    %esi,%eax
  pde = &pgdir[PDX(va)];
80106d98:	89 c1                	mov    %eax,%ecx
80106d9a:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80106d9d:	8b 0c 8a             	mov    (%edx,%ecx,4),%ecx
80106da0:	f6 c1 01             	test   $0x1,%cl
80106da3:	75 13                	jne    80106db8 <loaduvm+0x48>
      panic("loaduvm: address should exist");
80106da5:	83 ec 0c             	sub    $0xc,%esp
80106da8:	68 bf 77 10 80       	push   $0x801077bf
80106dad:	e8 ce 95 ff ff       	call   80100380 <panic>
80106db2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106db8:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106dbb:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106dc1:	25 fc 0f 00 00       	and    $0xffc,%eax
80106dc6:	8d 8c 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%ecx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106dcd:	85 c9                	test   %ecx,%ecx
80106dcf:	74 d4                	je     80106da5 <loaduvm+0x35>
    if(sz - i < PGSIZE)
80106dd1:	89 fb                	mov    %edi,%ebx
80106dd3:	b8 00 10 00 00       	mov    $0x1000,%eax
80106dd8:	29 f3                	sub    %esi,%ebx
80106dda:	39 c3                	cmp    %eax,%ebx
80106ddc:	0f 47 d8             	cmova  %eax,%ebx
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106ddf:	53                   	push   %ebx
80106de0:	8b 45 14             	mov    0x14(%ebp),%eax
80106de3:	01 f0                	add    %esi,%eax
80106de5:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80106de6:	8b 01                	mov    (%ecx),%eax
80106de8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106ded:	05 00 00 00 80       	add    $0x80000000,%eax
80106df2:	50                   	push   %eax
80106df3:	ff 75 10             	push   0x10(%ebp)
80106df6:	e8 b5 ac ff ff       	call   80101ab0 <readi>
80106dfb:	83 c4 10             	add    $0x10,%esp
80106dfe:	39 d8                	cmp    %ebx,%eax
80106e00:	75 1e                	jne    80106e20 <loaduvm+0xb0>
  for(i = 0; i < sz; i += PGSIZE){
80106e02:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106e08:	39 fe                	cmp    %edi,%esi
80106e0a:	72 84                	jb     80106d90 <loaduvm+0x20>
}
...
80106e30:	68 30 7a 10 80       	push   $0x80107a30
...
80106e4e:	0f 88 98 00 00 00    	js     80106eec <allocuvm+0xac>
80106e54:	89 f2                	mov    %esi,%edx
  if(newsz < oldsz)
80106e56:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106e59:	0f 82 a1 00 00 00    	jb     80106f00 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106e5f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e62:	05 ff 0f 00 00       	add    $0xfff,%eax
80106e67:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106e6c:	89 c7                	mov    %eax,%edi
  for(; a < newsz; a += PGSIZE){
80106e6e:	39 f0                	cmp    %esi,%eax
80106e70:	0f 83 8d 00 00 00    	jae    80106f03 <allocuvm+0xc3>
80106e76:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80106e79:	eb 44                	jmp    80106ebf <allocuvm+0x7f>
...
80106e8b:	e8 10 d8 ff ff       	call   801046a0 <memset>
...
80106e9f:	89 fa                	mov    %edi,%edx
80106ea1:	50                   	push   %eax
80106ea2:	8b 45 08             	mov    0x8(%ebp),%eax
80106ea5:	e8 a6 fb ff ff       	call   80106a50 <mappages>
80106eaa:	83 c4 10             	add    $0x10,%esp
80106ead:	85 c0                	test   %eax,%eax
80106eaf:	78 5f                	js     80106f10 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80106eb1:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106eb7:	39 f7                	cmp    %esi,%edi
80106eb9:	0f 83 89 00 00 00    	jae    80106f48 <allocuvm+0x108>
    mem = kalloc();
80106ebf:	e8 9c b7 ff ff       	call   80102660 <kalloc>
...
80106ecd:	68 dd 77 10 80       	push   $0x801077dd
80106ed2:	e8 d9 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106ed7:	83 c4 10             	add    $0x10,%esp
80106eda:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106edd:	74 0d                	je     80106eec <allocuvm+0xac>
80106edf:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106ee2:	8b 45 08             	mov    0x8(%ebp),%eax
80106ee5:	89 f2                	mov    %esi,%edx
80106ee7:	e8 a4 fa ff ff       	call   80106990 <deallocuvm.part.0>
    return 0;
80106eec:	31 d2                	xor    %edx,%edx
}
80106eee:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106ef1:	89 d0                	mov    %edx,%eax
80106ef3:	5b                   	pop    %ebx
80106ef4:	5e                   	pop    %esi
80106ef5:	5f                   	pop    %edi
80106ef6:	5d                   	pop    %ebp
...
80106eff:	00 
    return oldsz;
80106f00:	8b 55 0c             	mov    0xc(%ebp),%edx
}
80106f03:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106f06:	89 d0                	mov    %edx,%eax
80106f08:	5b                   	pop    %ebx
80106f09:	5e                   	pop    %esi
80106f0a:	5f                   	pop    %edi
80106f0b:	5d                   	pop    %ebp
...
80106f13:	68 f5 77 10 80       	push   $0x801077f5
80106f18:	e8 93 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106f1d:	83 c4 10             	add    $0x10,%esp
80106f20:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106f23:	74 0d                	je     80106f32 <allocuvm+0xf2>
80106f25:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106f28:	8b 45 08             	mov    0x8(%ebp),%eax
80106f2b:	89 f2                	mov    %esi,%edx
80106f2d:	e8 5e fa ff ff       	call   80106990 <deallocuvm.part.0>
      kfree(mem);
80106f32:	83 ec 0c             	sub    $0xc,%esp
80106f35:	53                   	push   %ebx
80106f36:	e8 65 b5 ff ff       	call   801024a0 <kfree>
      return 0;
80106f3b:	83 c4 10             	add    $0x10,%esp
    return 0;
80106f3e:	31 d2                	xor    %edx,%edx
80106f40:	eb ac                	jmp    80106eee <allocuvm+0xae>
80106f42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80106f48:	8b 55 e4             	mov    -0x1c(%ebp),%edx
}
...
80106f53:	5d                   	pop    %ebp
80106f54:	c3                   	ret
80106f55:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106f5c:	00 
...
80106f70:	5d                   	pop    %ebp
80106f71:	e9 1a fa ff ff       	jmp    80106990 <deallocuvm.part.0>
...
80106f82:	5d                   	pop    %ebp
80106f83:	c3                   	ret
80106f84:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106f8b:	00 
...
80106fab:	e8 e0 f9 ff ff       	call   80106990 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106fb0:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80106fb6:	eb 0f                	jmp    80106fc7 <freevm+0x37>
80106fb8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106fbf:	00 
...
80106fde:	e8 bd b4 ff ff       	call   801024a0 <kfree>
...
80106ff3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ff4:	e9 a7 b4 ff ff       	jmp    801024a0 <kfree>
    panic("freevm: no pgdir");
80106ff9:	83 ec 0c             	sub    $0xc,%esp
80106ffc:	68 11 78 10 80       	push   $0x80107811
...
8010701c:	74 5e                	je     8010707c <setupkvm+0x6c>
  memset(pgdir, 0, PGSIZE);
8010701e:	83 ec 04             	sub    $0x4,%esp
80107021:	89 c6                	mov    %eax,%esi
...
80107043:	ff 73 0c             	push   0xc(%ebx)
80107046:	50                   	push   %eax
80107047:	29 c1                	sub    %eax,%ecx
80107049:	89 f0                	mov    %esi,%eax
8010704b:	e8 00 fa ff ff       	call   80106a50 <mappages>
...
80107074:	e8 17 ff ff ff       	call   80106f90 <freevm>
      return 0;
80107079:	83 c4 10             	add    $0x10,%esp
}
8010707c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return 0;
8010707f:	31 f6                	xor    %esi,%esi
}
...
80107085:	5d                   	pop    %ebp
80107086:	c3                   	ret
80107087:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010708e:	00 
8010708f:	90                   	nop
...
8010709b:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070b6:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
801070b9:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
801070bc:	89 c1                	mov    %eax,%ecx
801070be:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
801070c1:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
801070c4:	f6 c2 01             	test   $0x1,%dl
801070c7:	75 17                	jne    801070e0 <clearpteu+0x30>
  pte_t *pte;
...
801070cc:	68 22 78 10 80       	push   $0x80107822
801070d1:	e8 aa 92 ff ff       	call   80100380 <panic>
801070d6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801070dd:	00 
...
801070f7:	74 d0                	je     801070c9 <clearpteu+0x19>
  *pte &= ~PTE_U;
801070f9:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801070fc:	c9                   	leave
801070fd:	c3                   	ret
...
80107106:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80107109:	e8 02 ff ff ff       	call   80107010 <setupkvm>
8010710e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107111:	85 c0                	test   %eax,%eax
80107113:	0f 84 e9 00 00 00    	je     80107202 <copyuvm+0x102>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107119:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010711c:	85 c9                	test   %ecx,%ecx
8010711e:	0f 84 b2 00 00 00    	je     801071d6 <copyuvm+0xd6>
80107124:	31 f6                	xor    %esi,%esi
80107126:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010712d:	00 
8010712e:	66 90                	xchg   %ax,%ax
  if(*pde & PTE_P){
80107130:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
80107133:	89 f0                	mov    %esi,%eax
80107135:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107138:	8b 04 81             	mov    (%ecx,%eax,4),%eax
8010713b:	a8 01                	test   $0x1,%al
8010713d:	75 11                	jne    80107150 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
8010713f:	83 ec 0c             	sub    $0xc,%esp
80107142:	68 2c 78 10 80       	push   $0x8010782c
...
80107152:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80107157:	c1 ea 0a             	shr    $0xa,%edx
8010715a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80107160:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107167:	85 c0                	test   %eax,%eax
80107169:	74 d4                	je     8010713f <copyuvm+0x3f>
    if(!(*pte & PTE_P))
8010716b:	8b 00                	mov    (%eax),%eax
8010716d:	a8 01                	test   $0x1,%al
8010716f:	0f 84 9f 00 00 00    	je     80107214 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107175:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80107177:	25 ff 0f 00 00       	and    $0xfff,%eax
8010717c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
8010717f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107185:	e8 d6 b4 ff ff       	call   80102660 <kalloc>
8010718a:	89 c3                	mov    %eax,%ebx
8010718c:	85 c0                	test   %eax,%eax
8010718e:	74 64                	je     801071f4 <copyuvm+0xf4>
      goto bad;
...
801071d6:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
801071ec:	e8 af b2 ff ff       	call   801024a0 <kfree>
      goto bad;
801071f1:	83 c4 10             	add    $0x10,%esp
  freevm(d);
801071f4:	83 ec 0c             	sub    $0xc,%esp
801071f7:	ff 75 e0             	push   -0x20(%ebp)
801071fa:	e8 91 fd ff ff       	call   80106f90 <freevm>
  return 0;
801071ff:	83 c4 10             	add    $0x10,%esp
    return 0;
80107202:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
80107209:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80107217:	68 46 78 10 80       	push   $0x80107846
8010721c:	e8 5f 91 ff ff       	call   80100380 <panic>
...
80107244:	0f 84 f8 00 00 00    	je     80107342 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107296:	e9 9d 00 00 00       	jmp    80107338 <copyout+0xb8>
...
801072b2:	74 74                	je     80107328 <copyout+0xa8>
      return -1;
    n = PGSIZE - (va - va0);
...
801072d0:	e8 5b d4 ff ff       	call   80104730 <memmove>
    len -= n;
    buf += n;
...
801072e5:	74 51                	je     80107338 <copyout+0xb8>
  if(*pde & PTE_P){
...
801072fd:	0f 84 46 00 00 00    	je     80107349 <copyout.cold>
  return &pgtab[PTX(va)];
...
8010731d:	f7 d1                	not    %ecx
8010731f:	83 e1 05             	and    $0x5,%ecx
80107322:	0f 84 78 ff ff ff    	je     801072a0 <copyout+0x20>
  }
  return 0;
}
...
80107342 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107342:	a1 00 00 00 00       	mov    0x0,%eax
80107347:	0f 0b                	ud2

80107349 <copyout.cold>:
80107349:	a1 00 00 00 00       	mov    0x0,%eax
8010734e:	0f 0b                	ud2
